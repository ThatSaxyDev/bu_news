...
class RejectedTile extends ConsumerWidget {
  final String name;
  ...
  void reapply(WidgetRef ref, BuildContext context) {
    ref.read(communityControllerProvider.notifier).reapplyToCreateCommunity(
          context: context,
          communityName: name,
            ...
            children: [
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  child: Text(
                    status == 'rejected' ? 'Re-apply' : status.toCapitalized(),
                    style: TextStyle(
                      fontSize: 14.sp,
                    ),
                  ),
